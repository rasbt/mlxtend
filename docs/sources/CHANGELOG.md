...
- utils.Counter now accepts a name variable to help distinguish between multiple counters, and time precision can be set with the 'precision' kwarg [#278](https://github.com/rasbt/mlxtend/pull/278)
