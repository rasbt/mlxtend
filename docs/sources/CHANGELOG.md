...
- utils.Counter now accepts a name variable to help distinguish between multiple counters, time precision has been updated to .00 seconds [#278](https://github.com/rasbt/mlxtend/pull/278)
