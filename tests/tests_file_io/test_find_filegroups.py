...
def test_ignore_substring():
    ...
    f1_1 = os.path.join(master_path, d1, 'file_1.log')
    f1_2 = os.path.join(master_path, d3, 'file_1.txt')
    
    expect_dict_1 = {'file_1': [f1_1, f1_2]}

    assert(find_filegroups(paths=[d1,d2,d3], substring='file_1', ignore_substring='file_1.c') == expect_dict_1)
